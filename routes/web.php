...
Route::middleware('auth')->group(function(){
 Route::get('/admin/layouts/{layout}/edit', fn(\App\Models\Layout $layout) => redirect()->route('visual-editor', $layout)->with('status', 'Se ha abierto el editor visual.'))->name('layouts.classic.redirect');
